...
<div class="alert alert-info">
  ...
  <p>For full featured Help examples in SuperCollider, ATK example soundfiles are required. Install the ATK as above, then download example files here.</P>
  ...
  <p>If the ATK has been correctly installed, the above code will open the ATK's user support directory. Place the downloaded soundfile here.</p>
